function probarValidarIntegrantes() {
  console.assert(
    validarIntegrantes('') === 'El campo integrantes debe tener al menos un numero',
    'Validar integrantes no valido que el campo no este vacio',
  );
  console.assert(
    validarIntegrantes('0') === 'El campo integrantes debe tener al menos un numero',
    'Validar integrantes no valido que el campo no tenga solamente un 0',
  );
  console.assert(
    validarIntegrantes('1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111') === 'El campo debe tener menos de 50 integrantes',
...
function probarValidarEdadIntegrantes() {
  console.assert(
    validarEdadIntegrantes('') === 'El campo edad integrantes debe tener al menos un numero',
    'Validar edad integrantes no valido que el campo no este vacio',
  );
  console.assert(
    validarEdadIntegrantes('0') === 'El campo edad integrantes debe tener al menos un numero',
